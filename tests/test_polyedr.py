...
4	1    4    8    5"""
    ...
    def test_value1(self):
        self.assertAlmostEqual(Polyedr('data/test1.geom').value(), 10000.0, 2)

    def test_value2(self):
        self.assertEqual(Polyedr('data/test2.geom').value(), 0.0)

    def test_value3(self):
        self.assertEqual(Polyedr('data/test3.geom').value(), 0.0)
